...
- Recibir webhooks de Evolution y reenviar mensajes a `AI_dialer`.
...
| `API_EXECUTE_INTERNAL_SERVICE_SECRET_KEY`, `AI_DIALER_INTERNAL_SERVICE_SECRET_KEY`, `CALLBACK_MANUAL_INTERNAL_SERVICE_SECRET_KEY`, `TASKS_INTERNAL_SERVICE_SECRET_KEY` | Claves confiadas por issuer para verificar JWT internos |
...
| `SERVICE_AI_DIALER_URL` | URL interna de `AI_dialer` |
